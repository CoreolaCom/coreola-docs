...
├─ utils/           # Standalone low-level utilities
...
A smaller set of standalone, dependency-free utilities.
...
The split between `helpers/` and `utils/` is by dependencies: `utils/` knows nothing about Redux, MUI, or the rest of the app; `helpers/` may.
